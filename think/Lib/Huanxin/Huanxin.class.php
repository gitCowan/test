...
class Huanxin {
	...
	public function __construct($options) {
		$this->client_id = isset ( $options ['client_id'] ) ? $options ['client_id'] : 'YXA6E3dX8HGwEeaXYrdFV7t71Q';
		$this->client_secret = isset ( $options ['client_secret'] ) ? $options ['client_secret'] : 'YXA6pEtc2XvWDI8OKRsOkFt4WPS0HyM';
		$this->org_name = isset ( $options ['org_name'] ) ? $options ['org_name'] : '914101053494003060';
		$this->app_name = isset ( $options ['app_name'] ) ? $options ['app_name'] : 'aishangxiu';
...
// +----------------------------------------------------------------------
	 ...
	 * 自定义参数
	 */
	function sendMessage($from_user = "admin", $usernames, $msg_type='txt', $msg_content='', $target_type = "users", $ext=[]) {
